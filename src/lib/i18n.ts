...
const translations = {
  es: {
    ...
    tabJson: 'Grafo JSON',
    dropTitleJson: 'Arrastra un grafo exportado aquí',
    dropSubtitleJson: 'o haz clic para seleccionar un archivo .json',
    errNotJson: 'Por favor sube un archivo .json',
    errInvalidJson: 'El JSON no tiene el formato de grafo esperado (nodes + relationships)',
  ...
  en: {
    ...
    tabJson: 'JSON Graph',
    dropTitleJson: 'Drop an exported graph here',
    dropSubtitleJson: 'or click to select a .json file',
    errNotJson: 'Please upload a .json file',
    errInvalidJson: 'The JSON does not have the expected graph format (nodes + relationships)',
