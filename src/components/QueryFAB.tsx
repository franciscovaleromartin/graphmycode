...
export const QueryFAB = () => {
  ...
  return (
    <div
      ref={panelRef}
      className="absolute bottom-36 left-4 z-20 w-[480px] max-w-[calc(100%-2rem)] animate-fade-in rounded-xl border border-cyan-500/30 bg-deep/95 shadow-[0_0_40px_rgba(6,182,212,0.2)] backdrop-blur-md"
    >
